...
class NoduleProcessor:
    def __init__(self, ct_image_file, nodule_locations, clinical_information, mode="2D", model_name="I3D_UNet-3D-20251208_090637-cls-BCEDice", device="cpu"):
        """
        Parameters
        ----------
        ...
        self.processor = MalignancyProcessor(mode=mode, suppress_logs=True, model_root=RESOURCE_PATH, model_name=model_name, device=device)
...
def run(mode="3D", model_name="I3D_UNet-3D-20251208_090637-cls-BCEDice", device="cpu"):
    # Read the inputs
    ...
    print(input_nodule_locations, input_clinical_information)
